...
void lsq(dt *lleft,dt *rright,dt *d_res,int m,int n,int r){
	...
	magma_scopymatrix(r,r*batch,lleft,r,d_left,lddl,queue);
	magma_scopymatrix(r,1*batch,rright,r,d_right,lddr,queue);
...
//	magma_sgetmatrix(r,batch*1,d_right,lddr,res,r,queue);
	magma_scopymatrix(r,batch*1,d_right,lddr,d_res,r,queue);
